...
import { ClassifierListIcon } from "../icons/appIcons";
...
const handleRegenerate = async () => {
 ...
 const uniqueStakeholders = useMemo(() => {
  ...
  // const [isStakeholderFilterOpen, setIsStakeholderFilterOpen] = useState(false);
   ...
   useEffect(() => {
  // Show the success message when the page/component loads
  setShowSuccessMessage(true);
      ...
      <div className="flex flex-row items-center border-b border-gray-700 px-1 py-1 mt-[-2px]">
        {/* <div className="shrink-0 ">
         <span className="text-black dark:text-white">
          <ClassifierListIcon></ClassifierListIcon>
          </span> 
...
<Table >
  ...
  <TableRow>
    <TableHead className="text-left cursor-pointer w-[100px]" onClick={() => toggleSort("requirement_id")}>
      <div className="flex items-center gap-1">
    ...
    <TableHead className="text-left cursor-pointer w-[120px]" onClick={() => toggleSort("catogery")}>
      <div className="flex items-center gap-1">
        Category
...
{sortKey === "catogery" ? (
    ...
    <TableHead className="text-left cursor-pointer w-[120px]" onClick={() => toggleSort("confidence_score")}>
      <div className="flex items-center gap-1">
    ...
    <TableHead className="text-left cursor-pointer w-[150px]" onClick={() => toggleSort("stakeholders")}>
      <div className="flex items-center gap-1">
    ...
    <TableHead className="text-left cursor-pointer w-[200px]" onClick={() => toggleSort("requirement_text")}>
      <div className="flex items-center gap-1">
    ...
    <ScrollArea className="overflow-y-hidden h-[220px] mt-2 scrollbar-thin">    
 ...
 {/* <div className="pr-1 mt-2 space-y-2 h-[215px] overflow-y-auto scrollbar-thin border border-[#4D4B4B] bg-[#26262675] rounded-lg"> */}
      ...
      index % 2 === 0 ? 'bg-[#d0d0d0] dark:bg-[#181818]' : 'bg-[#ececec]	dark:bg-[#2a2a2a]'
              ...
              <TableCell className="px-4 w-[80px] ">{req.category}</TableCell>
              ...
              <TableCell className="px-2 w-[120px] whitespace-normal break-words">{req.stakeholders.join(",")}</TableCell>
              <TableCell className="whitespace-normal break-words w-[250px] max-w-xs">{req.description}</TableCell>
            </TableRow>
          ))}
        </TableBody>
        {/* </div> */}
  ...
  {/* Message section with reserved space */}
